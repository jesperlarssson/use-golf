  ...
  return <footer className="pb-24 lg:pb-0">
    <section aria-labelledby="instagram-heading" className="border-t border-black/15 px-6 py-16 sm:px-10 lg:px-16 lg:py-20">
      <div className="mx-auto max-w-screen-2xl">
        <div data-reveal className="mb-8 flex flex-col justify-between gap-5 sm:flex-row sm:items-end"><div><h2 id="instagram-heading" className="text-balance text-3xl font-normal tracking-[-.035em] sm:text-4xl">Följ livet på USE.</h2></div><a href={instagram} target="_blank" rel="noopener noreferrer" className="inline-flex min-h-11 items-center gap-6 text-sm underline underline-offset-8">Följ @use__golf på Instagram <span aria-hidden="true">↗</span></a></div>
