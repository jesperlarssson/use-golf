...
export default async function MembershipPage() {
  ...
  return <>
    ...
    <section className="mx-auto max-w-screen-2xl px-6 py-20 sm:px-10 lg:px-16 lg:py-28">
      <div className="mb-12 flex max-w-2xl flex-col gap-6"><div><h2 className="max-w-lg text-balance text-4xl font-normal leading-[1.1] tracking-[-.035em] md:text-5xl">Det här ingår.</h2></div><p className="max-w-sm text-base leading-relaxed text-[var(--foreground)]/75">För dig som gärna spelar en runda till. Här är det som ingår när du blir en del av USE.</p></div>
      <div className="grid border-t border-black/20 sm:grid-cols-2 lg:grid-cols-4">{benefits.map(benefit => <article key={benefit.title} className="border-b border-black/20 py-8 sm:odd:pr-8 sm:even:pl-8 lg:border-b-0 lg:px-7 lg:first:pl-0 lg:last:pr-0 lg:[&:not(:last-child)]:border-r">
