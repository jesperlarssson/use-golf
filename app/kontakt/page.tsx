...
export default function KontaktPage() {
  return <>
    ...
    <section aria-label="Kontaktuppgifter" className="mx-auto grid max-w-screen-2xl gap-10 px-6 py-16 sm:px-10 md:grid-cols-3 lg:px-16 lg:py-20">
      <div><h2 className="mb-5 text-xs uppercase tracking-[.2em] text-[var(--brand-olive-900)]">Säg hej</h2><a href="mailto:hello@usegolf.se" className="flex min-h-11 items-center text-xl tracking-tight hover:underline">hello@usegolf.se</a><a href="tel:+46767174034" className="flex min-h-11 items-center text-xl tracking-tight hover:underline">076-717 40 34</a></div>
      <div><h2 className="mb-5 text-xs uppercase tracking-[.2em] text-[var(--brand-olive-900)]">Hitta hit</h2><p className="text-xl leading-relaxed tracking-tight">Krogabäcksvägen 2, plan 3<br />436 53 Hovås</p><p className="mt-3 max-w-xs text-sm leading-relaxed text-[var(--foreground)]/75">Ta hissen till plan 3 i parkeringshuset. Vi delar entré med Jumpy.</p></div>
      <div id="oppettider" className="scroll-mt-28"><h2 className="mb-5 text-xs uppercase tracking-[.2em] text-[var(--brand-olive-900)]">Öppettider</h2><p className="text-xl leading-relaxed tracking-tight">Alla dagar<br /><span className="tabular-nums">09:00–22:00</span></p><p className="mt-3 max-w-xs text-sm leading-relaxed text-[var(--foreground)]/75">Två timmars fri parkering i parkeringshuset. Aktivera parkeringen i EasyPark när du kommer.</p></div>
    </section>
